...
//    }
    ...
    /**
     * @return Attraction[] Returns an array of Hotel objects
     */
    public function findAttractionsWithAddressesPhotos(): array
    {
        $value = "";

        return $this->createQueryBuilder('a')
            ->andWhere('a.address != :val')
            ->andWhere('a.photoSmallUrl != :val')
            ->andWhere('a.website != :val')
            ->setParameter('val', $value)
            ->distinct()
            ->getQuery()
            ->getResult()
